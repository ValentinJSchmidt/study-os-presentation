...
\noindent We also anticipated professors complaining about AI spam, so we instructed the skill to output a clear disclaimer in order to encourage students to atleast modify the generated e-mails and drafts.
...
have fixed the session ending too early, which was the actual problem. Still professors can still list thesis topics on their own website, and the skill will find them.

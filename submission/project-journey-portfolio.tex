...
Our initial idea was a full-stack web app for students and professors. The professors could easily list their recent thesis topics while the students can 
search over the list of available topics and find their most suitable match. The motivation came from out own experience of searching and finding a suitable thesis topic. At the university there are multiple different data sources like the official university 
website, alma and additionally most of the professors also have a private lab based website. 
Our first hypothesis was, that the major problem is that there is no single source of truth. 
...
Our initial target group were students and professors of the Department of Computer Science at the University of Tuebingen. 
...
To mitigate this discrepancy, we planned a user studys for professors, where they could give us their point of view, without rating the actual idea itself. We wanted to understand the reasons behind the missing thesis list and if it is intended or just fell of due to the lack of time.

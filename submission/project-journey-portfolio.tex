...
So at first we thought that the problem was that there was no central list of topic. 
With the feedback of professors we knew that this was not the real problem and it would not have been maintainable either.
...
\begin{itemize}
  ...
  \item We discovered our new formulation of the problem : We solve the problem of finding a suitable thesis topic for students by providing a tool that helps 
\end{itemize}

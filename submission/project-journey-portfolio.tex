...
\begin{itemize}
  \item Two user groups, and this distinction matters for the story: students
    ...
    depend on.
  \item We interviewed a substantial number of professors via E-Mail. Main documented
    insights:
    \begin{itemize}
      \item Roughly half rejected a central platform outright; only about a
        third were conditionally open to it.
        Reason for rejetion where that the professors think that fitting a student to a thesis topic is a personal process and that they want to get to know the student first.
  ...
  \item The course professor later gave feedback that shifted what the product
    ...
    want --- not the concrete proposals the tool outputs.
  ...
  \item We have tried to reach out to students as well and even set up a survey on SocSci.org to get their feedback on the intial idea and sent it through the mailing list of the fachschaft. However response was slow. Therefore we were limited to informal conversations with fellow students and friends. Most of them are not on the level that they trust AI  completely.
...
\subsection*{What we have}
We at first tried to find a problem that fit our rough goal a problem we had and we knew from our own student life. Finding the right bachelor or master thesis can be difficult.  We at first 
